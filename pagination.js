...
(function (factory) {
    ...
    var Page = function (element, options) {
        var defaultOption = {
            ...
            pageSize: 10,
            total: 0,
            pageBtnCount: 11,  //不包括ellipsisEls
    ...
    Page.prototype = {
        ...
        renderPagination: function () {
            var option = {
                ...
                ellipsisTmpl: this.options.ellipsisTmpl
            }
            var lastPageNum = this.getLastPageNum();
        ...
        */
        renderPages: function (pageIndex, pageSize, total, pageBtnCount, options) {
            ...
            if (lastPageNumber <= pageBtnCount) {
                ...
                var firstSllipsisEl = this.renderPerPage(options.ellipsisTmpl, void 0);
                var lastSllipsisEl = firstSllipsisEl.clone();
                ...
                if (pageNumber < frontBtnNum) {
                    if (options.showFirstLastBtn) {
                        ...
                        if (lastSllipsisEl) html.push(lastSllipsisEl);
                        html.push(lastPage);
                        html.push(nextPage); 
                    } else {
                    ...
                    if (options.showFirstLastBtn) {
                        ...
                        if (firstSllipsisEl) html.unshift(firstSllipsisEl);
                    ...
                    if (options.showFirstLastBtn) {
                        ...
                        if (firstSllipsisEl) {
                        	html.unshift(firstSllipsisEl);
                        	html.push(lastSllipsisEl);
                        }
                        html.unshift(firstPage);
                       	html.push(lastPage);
                       	html.unshift(prevPage);
